      ...
      <div className="max-w-5xl mx-auto">
        ...
        {cartProductDetails.length === 0 ? (
          <p className="text-[#B7C7D6] text-lg">
            ...
            <Link
              href="/"
              className="text-[#E6CBA8] underline hover:text-[#B7C7D6]"
            >
              تسوق الآن
            </Link>
          </p>
              ...
              {cartProductDetails.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 md:ml-4">
                    <h2 className="font-semibold text-[#14273E] text-lg">
                      {item.title}
                    </h2>
                    <p className="mt-1 text-[#14273E]">
                  ...
                  <div className="flex items-center gap-2 mt-4 md:mt-0">
                    ...
                    <button
                      onClick={() => dispatch(updateCartQuantity({id: item.id.toString(),quantity: 0}))}
